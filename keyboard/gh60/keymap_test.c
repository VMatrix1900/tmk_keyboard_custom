// Generated by TKG at 2016-01-01 22:57:42
...
#endif
    [0] = KEYMAP_TKG(
        ESC, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL, CAPS, \
        TAB, Q,   W,   E,   R,   T,   Y,   U,   I,   O,   P,   LBRC,RBRC,BSLS, \
        LCTL,A,   S,   D,   F,   G,   H,   J,   K,   L,   SCLN,QUOT,     ENT,  \
        LSFT,     Z,   X,   C,   V,   B,   N,   M,   COMM,DOT, SLSH,FN0, RSFT, \
        FN0, LALT,LGUI,          SPC,                BSPC,RGUI,RALT,APP, RCTL),
    [1] = KEYMAP_TKG(
        GRV, F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12, TRNS, \
        TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,CALC,TRNS,INS, TRNS,PSCR,SLCK,TRNS,TRNS, \
        TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,LEFT,DOWN,UP,  RGHT,HOME,PGUP,     TRNS, \
        TRNS,     TRNS,TRNS,TRNS,TRNS,TRNS,VOLD,VOLU,MUTE,END, PGDN,TRNS,TRNS, \
