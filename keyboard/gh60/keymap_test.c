// Generated by TKG at 2016-03-02 22:43:12
...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
    ...
    [0] = KEYMAP_TKG(
        ...
        FN0, LALT,LGUI,          SPC,                          RGUI,APP, RCTL),
    [1] = KEYMAP_TKG(
        GRV, F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12, DEL,  \
        TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,HOME,PGUP,TRNS,TRNS, \
        TRNS,MUTE,VOLD,VOLU,TRNS,TRNS,LEFT,DOWN,UP,  RGHT,END, PGDN,     TRNS, \
        TRNS,     TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,MPRV,MPLY,MNXT,TRNS,TRNS, \
